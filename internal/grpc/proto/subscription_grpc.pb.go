...
type SubscriptionServiceClient interface {
	...
	ListSubscriptions(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error)
}
...
func (c *subscriptionServiceClient) ListSubscriptions(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type SubscriptionServiceServer interface {
	...
	ListSubscriptions(context.Context, *ListRequest) (*ListResponse, error)
...
func (UnimplementedSubscriptionServiceServer) ListSubscriptions(context.Context, *ListRequest) (*ListResponse, error) {
...
func _SubscriptionService_ListSubscriptions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubscriptionServiceServer).ListSubscriptions(ctx, req.(*ListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SubscriptionService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/grpc/proto/subscription.proto",
}
